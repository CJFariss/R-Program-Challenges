...
##
## (3) Select any integer (arbitrary choice). Now, answer the following logical question: are any of the elements in one of the vectors created in step (1) or step (2) the same value as the selected integer?
##
