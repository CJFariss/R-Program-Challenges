...
##
## (10) Can you improve the precision of your function by transforming the numbers prior to multiplication using natural logs with the log() function? Hint: recall that exp(log(x) + log(x)) = x*x. So for example, the following statement in R is TRUE: exp(log(pi)+log(pi))==pi*pi
##
##########################################################################
