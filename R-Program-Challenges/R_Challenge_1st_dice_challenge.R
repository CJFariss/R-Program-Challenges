...
##
## (1) Write a program that simulates the role of one or more dice using the sample() function
## (2) The program should allow for ATLEAST two arguments: dice_type, dice_number
##
