...
##
## (4) change the program so that it can repeate stepts (1) - (4) for non-symetric matrices, such that m != n. 
##
...
##
## (5) Write a program to graphically display the results from (2) and (3). Hint: use a barplot().
##
##########################################################################
