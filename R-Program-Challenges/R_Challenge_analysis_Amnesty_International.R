## R_Challenge_analysis_Amnesty_International.R
##########################################################################
...
##
## (1) Write a program to load the AIR-2022-text-sections-themes.csv dataset into R.
##
## (2) Inspect and explore the AIR-2022-text-sections-themes data.
##
...
##
## (6) Create a barplot of the most frequent words by EVENT_TYPE for the entire dataset
##
##########################################################################
